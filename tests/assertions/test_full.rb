...
@tests.assertions.push(*[
  ...
  # Root path with public folder
  {
    ...
    'actual' => @tests.configs['full'].config['sites']['full']['root_path'],
  },
  ...
  # Root path, no public folder
  {
    ...
    'actual' => @tests.configs['full'].config['sites']['minimal']['root_path'],
  },
  ...
  # Subdomain root path with public folder
  {
    ...
    'actual' => @tests.configs['full'].config['sites']['app.full']['root_path'],
  },
  ...
  # Subdomain root path, no public folder
  {
    ...
    'actual' => @tests.configs['full'].config['sites']['help.minimal']['root_path'],
  },
  ...
  # vhost.conf file path
  {
    ...
    'actual' => @tests.configs['full'].config['sites']['full']['vhost_file'],
  },
  ...
  # Subdomain vhost.conf file path
  {
    ...
    'actual' => @tests.configs['full'].config['sites']['app.full']['vhost_file'],
  },
  ...
  # Subdomain host
  {
    ...
    'actual' => @tests.configs['full'].config['sites']['help.minimal']['host'],
  },
  ...
  # Subdomain host, parent has `www.` prefix
  {
    ...
    'actual' => @tests.configs['full'].config['sites']['app.full']['host'],
  },
  ...
  # Subdomain SSL, parent has SSL enabled
  {
    ...
    'expect' => true,
    'actual' => @tests.configs['full'].config['sites']['app.full']['ssl'],
  },
  ...
  # Subdomain SSL, parent has SSL disabled
  {
    ...
    'expect' => false,
    'actual' => @tests.configs['full'].config['sites']['help.minimal']['ssl'],
  },

  # DNS Hosts file
  {
    'name' => 'Full: DNS Hosts file should exist and contain all SSL-enabled hosts',
    'expect' => File.open(File.join(@assertions_dir, 'full.txt'), 'r').read.split("\n"),
    'actual' => [
